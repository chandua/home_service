          ...
          children: [
            Column(
              children: [
                ...
                if(_service!.eProvider!=null)if (_service!.eProvider!.available!)
                  Container(
                    width: 80,
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      ...
                      Flexible(
                        child: Text(
                          (_service!.eProvider!=null)?_service!.eProvider!.name! ?? '':'',
                          maxLines: 1,
                          overflow: TextOverflow.fade,
                          softWrap: false,
                          style: Get.textTheme.bodyText1,
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Text(
                          ...
                          (_service!.eProvider!=null)?_service!.eProvider!.firstAddress! ?? '':'',
                          maxLines: 1,
                          overflow: TextOverflow.fade,
                          softWrap: false,
                          style: Get.textTheme.bodyText1,
