...
class EService extends Model {
  ...
  EService.fromJson(Map<String, dynamic> json) {
    ...
    if(json['price']!=null)price = doubleFromJson(json, 'price');
    if(json['discount_price']!=null)discountPrice = doubleFromJson(json, 'discount_price');
    ...
    if(json['total_reviews']!=null)totalReviews = intFromJson(json, 'total_reviews');
    if(json['duration']!=null)duration = stringFromJson(json, 'duration');
    if(json['featured']!=null)featured = boolFromJson(json, 'featured');
    if(json['enable_booking']!=null)enableBooking = boolFromJson(json, 'enable_booking');
    if(json['is_favorite']!=null)isFavorite = boolFromJson(json, 'is_favorite');
    if(json['categories']!=null)categories = listFromJson<Category>(json, 'categories', (value) => Category.fromJson(value));
    if(json['sub_categories']!=null)subCategories = listFromJson<Category>(json, 'sub_categories', (value) => Category.fromJson(value));
   // if(json['e_provider']!=null)eProvider = objectFromJson(json, 'e_provider', (value) => EProvider.fromJson(value));
    super.fromJson(json);
  }
